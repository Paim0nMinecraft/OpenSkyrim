...
public final class InventoryUtils extends MinecraftInstance implements Listenable {
    ...
    public static void openPacket() {
        classProvider.createCPacketEntityAction(LiquidBounce.wrapper.getMinecraft().getThePlayer(), ICPacketEntityAction.WAction.OPEN_INVENTORY);
    }

    public static void closePacket() {
        mc2.getConnection().sendPacket(new CPacketCloseWindow());
    }
