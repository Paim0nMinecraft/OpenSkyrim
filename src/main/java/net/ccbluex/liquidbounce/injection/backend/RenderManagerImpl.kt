...
class RenderManagerImpl(val wrapped: RenderManager) : IRenderManager {
    ...
    override fun renderEntityAt(entity: ITileEntity, x: Double, y: Double, z: Double, partialTicks: Float) =
        TileEntityRendererDispatcher.instance.render(entity.unwrap(), x, y, z, partialTicks)

    override fun renderEntityWithPosYaw(
