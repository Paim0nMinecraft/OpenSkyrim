...
open class PacketImpl<T : Packet<*>>(val wrapped: T) : IPacket {
    ...
    override fun asSPacketEntityVelocity(): ISPacketEntityVelocity =
        SPacketEntityVelocityImpl(wrapped as SPacketEntityVelocity)
    ...
    override fun asSPacketResourcePackSend(): ISPacketResourcePackSend =
        SPacketResourcePackSendImpl(wrapped as SPacketResourcePackSend)

    override fun asCPacketHeldItemChange(): ICPacketHeldItemChange =
        CPacketHeldItemChangeImpl(wrapped as CPacketHeldItemChange)
    ...
    override fun asCPacketCustomPayload(): ICPacketCustomPayload =
        CPacketCustomPayloadImpl(wrapped as CPacketCustomPayload)

    override fun asCPacketHandshake(): ICPacketHandshake = CPacketHandshakeImpl(wrapped as C00Handshake)

    override fun asCPacketPlayerDigging(): ICPacketPlayerDigging =
        CPacketPlayerDiggingImpl(wrapped as CPacketPlayerDigging)
