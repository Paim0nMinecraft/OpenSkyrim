...
class RenderItemImpl(val wrapped: RenderItem) : IRenderItem {
    ...
    override fun renderItemAndEffectIntoGUI(stack: IItemStack, x: Int, y: Int) =
        wrapped.renderItemAndEffectIntoGUI(stack.unwrap(), x, y)

    override fun renderItemIntoGUI(stack: IItemStack, x: Int, y: Int) = wrapped.renderItemIntoGUI(stack.unwrap(), x, y)

    override fun renderItemOverlays(fontRenderer: IFontRenderer, stack: IItemStack, x: Int, y: Int) =
        wrapped.renderItemOverlays(fontRenderer.unwrap(), stack.unwrap(), x, y)
