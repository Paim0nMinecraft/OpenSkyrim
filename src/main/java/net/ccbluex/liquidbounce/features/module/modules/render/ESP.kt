...
class ESP : Module() {
    ...
    val modeValue = ListValue(
        "Mode",
        arrayOf("Box", "OtherBox", "WireFrame", "2D", "Real2D", "Outline", "ShaderOutline", "ShaderGlow", "datou"),
        "Box"
    )
    ...
    val datouValue = ListValue("datou", arrayOf("yaoer"), "yaoer")
            ...
            if (entity != mc.thePlayer && EntityUtils.isSelected(entity, false)) {
                ...
                when (mode.toLowerCase()) {
                    ...
                    "datou" -> {
                        ...
                        GL11.glPushMatrix()
                        GL11.glTranslatef(
                            pX.toFloat(), (pY + if (entity.sneaking) 0.8F else 1.3F).toFloat(),
                            pZ.toFloat()
                        )
