...
class FastUse : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("Instant", "NCP", "AAC", "CustomDelay", "GrimAC"), "NCP")
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        if (classProvider.isItemFood(usingItem) || classProvider.isItemBucketMilk(usingItem) || classProvider.isItemPotion(
                usingItem
            )
        ) {
