...
interface IClassProvider {
    ...
    fun createThreadDownloadImageData(
        cacheFileIn: File?,
        imageUrlIn: String,
    ...
    fun createCPacketPlayerBlockPlacement(
    ...
    fun createCPacketPlayerPosLook(
        x: Double,
        y: Double,
        z: Double,
        yaw: Float,
