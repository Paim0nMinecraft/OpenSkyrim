...
class WrappedMutableList<O, T, C : MutableList<O>>(wrapped: C, unwrapper: (T) -> O, wrapper: (O) -> T) :
    WrappedMutableCollection<O, T, C>(wrapped, unwrapper, wrapper), MutableList<T> {
    ...
    override fun listIterator(): MutableListIterator<T> =
        WrappedMutableCollectionIterator(wrapped.listIterator(), wrapper, unwrapper)

    override fun listIterator(index: Int): MutableListIterator<T> =
        WrappedMutableCollectionIterator(wrapped.listIterator(index), wrapper, unwrapper)
    ...
    override fun subList(fromIndex: Int, toIndex: Int): MutableList<T> =
        WrappedMutableList(wrapped.subList(fromIndex, toIndex), unwrapper, wrapper)

    class WrappedMutableCollectionIterator<O, T>(
        val wrapped: MutableListIterator<O>,
        val wrapper: (O) -> T,
        val unwrapper: (T) -> O
