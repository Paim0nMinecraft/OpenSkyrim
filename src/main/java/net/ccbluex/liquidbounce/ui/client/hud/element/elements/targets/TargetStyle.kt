...
abstract class TargetStyle(val name: String, val targetInstance: Target, val shaderSupport: Boolean) :
    ...
    var easingHealth = 0F
    val shieldIcon = ResourceLocation("paimon/shield.png")
    ...
    val shadowOpaque: Color
        get() = ColorUtils2.reAlpha(
            when (targetInstance.shadowColorMode.get().toLowerCase()) {
    ...
    fun getColor(color: Color) =
        ColorUtils2.reAlpha(color, color.alpha / 255F * (1F - targetInstance.getFadeProgress()))
