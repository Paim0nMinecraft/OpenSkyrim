    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            if (s.length() > 0) {
                ...
                Fonts.posterama.posterama16.posterama16.drawString(s1, l, i1, i);
                j1 += Fonts.posterama.posterama16.posterama16.stringWidth(s1);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                Fonts.posterama.posterama16.posterama16.drawString(s.substring(j), j1, i1, i);
            }

            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + Fonts.posterama.posterama16.posterama16.getHeight(), -3092272);
                } else {
                    Fonts.posterama.posterama16.posterama16.drawString("_", k1, i1, i);
                }
            }

            if (k != j) {
                int l1 = l + this.fontRendererInstance.stringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + Fonts.posterama.posterama16.posterama16.getHeight());
            }
        }
    }
