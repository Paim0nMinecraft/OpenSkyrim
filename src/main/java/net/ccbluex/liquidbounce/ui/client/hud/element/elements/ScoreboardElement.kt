...
//Shadow!!!!
        ...
        scoreCollection.forEachIndexed { index, score ->
            ...
            fun mixColors(color1: Color, color2: Color, hud: HUD): Color {
            ...
            fun getClientColor(hud: HUD): Color {
                return Color(hud.r.get(), hud.g.get(), hud.b.get())
            }

            fun getAlternateClientColor(hud: HUD): Color {
                return Color(hud.r2.get(), hud.g2.get(), hud.b2.get())
            }

            fun getClientColors(hud: HUD): Array<Color> {
                val firstColor: Color = mixColors(
                    getClientColor(hud),
                    getAlternateClientColor(hud), hud
                )
                val secondColor: Color = mixColors(
                    getAlternateClientColor(hud),
                    getClientColor(hud), hud
                )
                return arrayOf(firstColor, secondColor)
            }
            if (hud.ChineseScore.get())
                FontLoaders.F18.drawString(name, l1.toFloat(), height.toFloat(), listColor, shadowValue.get())
            else fontRenderer.drawString(name, l1.toFloat(), height.toFloat(), listColor, shadowValue.get())
