...
import cc.paimon.ui.hud.Target2
...
import xiatian.novoline.ui.NovolineEffects
import xiatian.novoline.ui.SessionInfo
...
open class HUD : MinecraftInstance() {
    ...
    companion object {
        ...
        val elements = arrayOf(
            ...
            Target::class.java,
            Radar::class.java,
            HealthRender::class.java,
            SessionInfo::class.java,
            NovolineEffects::class.java,
            xiatian.Effects::class.java,
            xiatian.Target::class.java,
            Target2::class.java
        )
