...
class GuiDonatorCape(private val prevGui: GuiAltManager) : WrappedGuiScreen() {
    ...
    override fun initGui() {
        ...
        representedScreen.buttonList.add(
            classProvider.createGuiButton(
                0,
                representedScreen.width / 2 - 100,
                representedScreen.height / 4 + 120,
                "Back"
            )
        )
        ...
        transferCodeField =
            classProvider.createGuiPasswordField(666, Fonts.posterama40, representedScreen.width / 2 - 100, 80, 200, 20)
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.posterama35.drawCenteredString("Donator Cape", representedScreen.width / 2.0f, 36.0f, 0xffffff)
        Fonts.posterama35.drawCenteredString(
            status,
            representedScreen.width / 2.0f,
            representedScreen.height / 4.0f + 80,
            0xffffff
        )
        ...
        Fonts.posterama40.drawCenteredString("§7Transfer Code:", representedScreen.width / 2.0f - 65, 66.0f, 0xffffff)
